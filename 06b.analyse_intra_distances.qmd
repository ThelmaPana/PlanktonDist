...
ggplot(df_intra_qt) +
  ...
  scale_colour_manual(values = df_intra_sig$colour) +
  labs(x = "Percentiles", y = "Null quantiles - plankton quantiles (cm)", colour = "Taxon") +
  theme_classic()
```
...
Save quantiles, Z-score and Kuiper stat.

```{r save}
save(df_intra_qt, file = "data/06b.df_intra_qt.Rdata")
