...
if (read_from_ecotaxa){
  ...
  # Save it
  save(sol_col, file = "data/01a.sol_col.Rdata")
} else {
  load("data/01a.sol_col.Rdata")
}
...
# Save it
write_parquet(plankton, sink = "data/01a.x_corrected_plankton_clean.parquet")
save(plankton_sub, file = "data/01a.x_corrected_plankton_sub.Rdata")
save(med_corr, file = "data/01a.corr_factor.Rdata")
```
