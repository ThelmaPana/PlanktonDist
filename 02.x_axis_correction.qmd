...
ggplot(sol_col) + geom_histogram(aes(x = ratio))
```
...
#  geom_density_2d(aes(x = corr, y = error, color = ..level..)) +
...
ggplot(df_z) + geom_histogram(aes(x = error), binwidth = 1)
ggplot(df_z) + geom_histogram(aes(x = error), binwidth = 0.02) + xlim(0, 1.1)
summary(df_z$error)
