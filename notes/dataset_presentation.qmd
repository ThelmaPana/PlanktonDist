...
Other way to test for overall randomness: draw quadrats of equal size in images and count organisms within quadrats (see <https://www.paulamoraga.com/book-spatial/complete-spatial-randomness.html>).
