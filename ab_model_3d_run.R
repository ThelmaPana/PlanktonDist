...
param_grid <- crossing(
  h = c(100000, 250000, 400000),    # Density bandwidth
  d_length = c(100, 250, 400),      # Displacement length (in px)
  prop_mv = 1                       # Proportion of points to move
)
...
## Save results ----
#--------------------------------------------------------------------------#
save(sim_res, file = "data/simulation_results.Rdata")
