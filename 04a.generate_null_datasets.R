...
dist_rand <- dist_rand %>% bind_rows()


## Old ----
#--------------------------------------------------------------------------#
write_parquet(dist_rand, sink = "data/04a.null_datasets_distances.parquet")


##TODO
## - 02b Kuiper test on all distances, to compare with plankton distances to find the distance threshold
## - 02c filter distances using identified threshold
## - 02d Kuiper test on filtered distances
#
