...
dist_all_2d <- do.call(bind_rows, dist_all_2d) %>% rename(dist = value)
...
# Combine results in a dataframe
dist_all_3d <- do.call(bind_rows, dist_all_3d) %>% rename(dist = value)
...
Indeed, close to the expected 2/3 ratio.
